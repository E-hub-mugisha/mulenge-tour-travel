                            ...
                            <div class="tg-blog-grid-item mb-30">
                                ...
                                <div class="tg-blog-standard-content">
                                    <h2 class="tg-blog-standard-title">
                                        <a href="{{ route('pages.tips.show', $tip->id ) }}">{{ $tip->title }}</a>
                                    </h2>
                                    ...
                                    <div class="tg-blog-sidebar-btn">
                                        <a href="{{ route('pages.tips.show', $tip->id ) }}" class="tg-btn tg-btn-switch-animation">
                                            <span class="d-flex align-items-center justify-content-center">
                                                <span class="btn-text">Read More</span>
                                                <span class="btn-icon ml-5">
                                                    <svg width="21" height="16" viewBox="0 0 21 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M0.995842 8.00001H19.9456M19.9456 8.00001L12.9707 1.02515M19.9456 8.00001L12.9707 14.9749" stroke="currentColor" stroke-width="1.77778" stroke-linecap="round" stroke-linejoin="round"></path>
                                                    </svg>
                                                </span>
                                                <span class="btn-icon ml-5">
                                                    <svg width="21" height="16" viewBox="0 0 21 16" fill="none" xmlns="http://www.w3.org/2000/svg">
