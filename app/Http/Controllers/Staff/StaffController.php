...
class StaffController extends Controller
{
    ...
    public function indexAccommodation()
    {
        ...
        return view('staff.accommodations.index', compact('accommodations'));
    }
    ...
    public function indexActivity()
    {
        ...
        return view('staff.activities.index', compact('activites'));
    }
    ...
    public function indextransportation()
    {
        ...
        return view('staff.transportations.index', compact('transportations'));
    }
