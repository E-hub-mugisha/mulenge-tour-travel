...
class TourController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('staff.tours.create', compact('activities', 'accommodations', 'transportations'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('staff.tours.index')->with('success', 'Tour created successfully!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('staff.tours.edit', compact('tour'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('staff.tours.index')->with('success', 'Tour updated successfully!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('staff.tours.index')->with('success', 'Tour deleted successfully!');
    }
}
