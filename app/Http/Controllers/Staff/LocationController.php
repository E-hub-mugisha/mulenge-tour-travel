...
class LocationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('staff.locations.index')->with('success', 'Location created successfully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('staff.locations.index')->with('success', 'Location updated successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('staff.locations.index')->with('success', 'Location deleted successfully');
    }
}
