    ...
    document.getElementById('payBtn').addEventListener('click', function() {
        ...
        FlutterwaveCheckout({
            ...
            callback: function(data) {
                const url = `/customer/tour/payment/callback?transaction_id=${encodeURIComponent(data.transaction_id)}&status=${encodeURIComponent(data.status)}&tx_ref=${encodeURIComponent(data.tx_ref)}`;
