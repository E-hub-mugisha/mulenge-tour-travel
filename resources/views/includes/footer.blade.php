<footer>
    <div class="tg-footer-area tg-footer-su-wrapper tg-footer-space include-bg" data-background="{{ asset('assets/pages/img/footer/footer.jpg')}}">
        <div class="container">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                        <div class="tg-footer-widget mb-40">
                            <div class="tg-footer-logo mb-20">
                                <a href="index.html"><img src="{{ asset('assets/pages/img/logo/logo-white.png')}}" alt=""></a>
                            </div>
