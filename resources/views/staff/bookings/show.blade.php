    ...
    <div class="row justify-content-center">
        <div class="card col-md-6 mt-5">
            ...
            <div class="card-body">
                ...
                <div class="mt-3">
                    <a href="{{ route('staff.bookings.edit', $booking->id) }}" class="btn btn-sm btn-warning">Edit Booking</a>
...
<div class="modal fade" id="updateBookingModal" tabindex="-1" aria-labelledby="updateBookingModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('staff.bookingsUpdateStatus', $booking->id ) }}" method="POST">
                @csrf
                @method('PUT')
