<footer>
    <div class="tg-footer-area tg-footer-su-wrapper tg-footer-space include-bg">
                ...
                <div class="row">
                        ...
                        <div class="tg-footer-widget mb-40">
                            <div class="tg-footer-logo mb-20">
                                <a href="{{ route('pages.home') }}">
                                    <h3 class="text-white">Mulenge Tours & Tourisms</h3>
                                </a>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                        <div class="tg-footer-widget tg-footer-link mb-40">
                            ...
                            <ul>
                                <li><a href="{{ route('pages.hotels') }}">Hotels</a></li>
                                <li><a href="{{ route('pages.destinations') }}">Destinations</a></li>
                                <li><a href="{{ route('pages.tours') }}">Tour Package</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
        ...
        <div class="tg-footer-copyright text-center">
            <span>
                Copyright <a href="#">©Mulenge Tours & Tourisms</a> | All Right Reserved
            </span>
        </div>
    </div>
</footer>