        ...
        <div class="row justify-content-center">
            <div class="col-xl-10">
                <div class="tg-hero-content text-center">
                    ...
                    <div class="tg-hero-tu-avatar-wrap d-flex justify-content-center flex-wrap align-items-center wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">
                        <span class="tg-hero-tu-avatar d-inline-block mr-10 mb-15">
                            <img src="{{ asset('assets/pages/img/hero/tu/avatar.png')}}" alt="">
                        </span>
                        <span class="tg-hero-tu-avatar-text d-inline-block mr-10 p-relative mb-15">35k People booked <br>dream place
                        ...
                        <form action="#">
                            <div class="tg-booking-form-input-group d-flex align-items-end justify-content-between">
                                <div class="tg-booking-form-parent-inner tg-hero-quantity p-relative mr-15 mb-10">
                                    <span class="tg-booking-form-title">Location:</span>
                                    <div class="tg-booking-add-input-field tg-booking-quantity-toggle">
                                        ...
                                        <span class="tg-booking-title-value">California City</span>
                                ...
                                <div class="tg-booking-form-parent-inner mr-15 mb-10">
                                    ...
                                    <div class="tg-booking-add-input-date p-relative">
                                        ...
                                        <span class="angle-down">
                                            <svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1.6665 1L6.99984 6.33333L12.3332 1" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="tg-booking-form-parent-inner tg-hero-quantity p-relative mr-15 mb-10">
                                    ...
                                    <div class="tg-booking-form-location-list tg-quantity tg-booking-quantity-active">
                                        ...
                                        <div class="tg-booking-form-search-btn mt-15 ">
                                            <button class="bk-search-button bk-search-button-2 w-100" type="submit">Ok</button>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-9">
                <div class="tg-location-section-title mb-30">
                    ...
                    <h2 class="tg-section-su-title text-capitalize wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".9s">Explore Top Destinations</h2>
                </div>
            </div>
            <div class="col-lg-3">
                        ...
                        <div class="swiper-slide">
                            <div class="tg-location-3-wrap  tg-location-su-wrap  p-relative mb-30 tg-round-25">
                                <div class="tg-location-thumb tg-round-25">
                                    <img class="w-100 tg-round-25" src="{{ asset('assets/pages/img/destination/tu/des-4.jpg')}}" alt="location">
                                </div>
                                <div class="tg-location-content tg-location-su-content">
                                    <div class="content">
                                        <h3 class="tg-location-title mb-5"><a href="tour-grid-1.html">{{ $location->name }}</a></h3>
...
<div class="tg-about-area p-relative z-index-1 pb-80">
    <img class="tg-about-su-right-shape d-none d-xl-block" src="{{ asset('assets/pages/img/about/su/right-shape.png')}}" alt="">
    <div class="container">
        <div class="row align-items-end">
            <div class="col-lg-5">
                <div class="tg-about-su-thumb p-relative mb-40 wow fadeInLeft" data-wow-delay=".4s" data-wow-duration=".6s">
                    <div class="tg-about-su-shape-2">
                        <img src="{{ asset('assets/pages/img/about/su/shape.png')}}" alt="">
                    </div>
                    <div class="tg-about-su-shape">
                        <img src="{{ asset('assets/pages/img/about/su/shape-2.png')}}" alt="">
                    </div>
                    <img src="{{ asset('assets/pages/img/about/su/thumb.png')}}" alt="">
                </div>
            </div>
            <div class="col-lg-7">
                <div class="tg-about-su-content-wrap ml-80 mb-30 wow fadeInRight" data-wow-delay=".4s" data-wow-duration=".6s">
                    <div class="tg-location-section-title mb-30">
                        <h5 class="tg-section-su-subtitle mb-15">Who we are</h5>
                        <h2 class="tg-section-su-title text-capitalize mb-15">Here is Great opportunity for adventure & travels</h2>
                        <p class="tg-section-su-para mb-10">Dorem ipsum dolor sit amet consectetur adipiscing elit. Mauris nullam the Lorem<br>
                    ...
                    <div class="tg-about-su-funfact-wrap mb-40">
                        <div class="tg-about-su-funfact-item mb-15">
                            <div class="tg-about-su-funfact-icon mb-20">
                                <img src="{{ asset('assets/pages/img/about/su/fun-3.png')}}" alt="">
                            </div>
                        ...
                        <div class="tg-about-su-funfact-item mb-15">
                            <div class="tg-about-su-funfact-icon mb-20">
                                <img src="{{ asset('assets/pages/img/about/su/fun-2.png')}}" alt="">
                            </div>
                            <div class="tg-about-su-funfact-text">
                        ...
                        <div class="tg-about-su-funfact-item mb-15">
                            <div class="tg-about-su-funfact-icon mb-20">
                                <img src="{{ asset('assets/pages/img/about/su/fun-1.png')}}" alt="">
                            </div>
                            <div class="tg-about-su-funfact-text">
                                <h3 class="mb-0">11,000+</h3>
                    ...
                    <div class="tg-about-su-author-wrap">
                        <div class="mr-30 mb-10">
                            <a class="tg-btn tg-btn-hover" href="about.html">More About Us</a>
                        </div>
                        <div class="tg-about-su-author d-flex align-items-center mb-10">
                            <div class="tg-about-su-author-avatar mr-10">
                                <img src="{{ asset('assets/pages/img/about/su/author.jpg')}}" alt="">
                            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="tg-listing-section-title-wrap text-center mb-40">
                    ...
                    <h2 class="tg-section-su-title text-capitalize wow fadeInUp mb-15" data-wow-delay=".5s" data-wow-duration=".9s">Our Amazing Featured Tour  Package The World</h2>
                </div>
            </div>
        </div>
        <div class="row">
...
<div class="tg-chose-area tg-chose-su-wrap pt-100 pb-105 p-relative z-index-9">
    <img class="tg-chose-2-shape d-none d-lg-block" src="{{ asset('assets/pages/img/chose/chose-2/shape.png')}}" alt="shape">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8">
                <div class="tg-chose-section-title text-center mb-40">
                    <h5 class="tg-section-su-subtitle su-subtitle-2 mb-20 wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">our Working Process</h5>
                    <h2 class="tg-section-su-title text-capitalize wow fadeInUp mb-15" data-wow-delay=".5s" data-wow-duration=".9s">See how we work step by step</h2>
                    <p class="tg-section-su-para tg-section-su-para-2 mb-10">Are you tired of the typical tourist destinations and areabetter looking<br>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 mb-25">
                <div class="tg-chose-2-content p-relative text-center z-index-1 wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".6s">
                    ...
                    <h4 class="tg-chose-2-title mb-15"><a href="contact.html">Best Travel Agency</a></h4>
                    <p>Are you tired offer theare typical tourist new destination</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 mb-25">
                <div class="tg-chose-2-thumb h-100 wow fadeInRight" data-wow-delay=".6s" data-wow-duration=".6s">
                    <img class="w-100 h-100" src="{{ asset('assets/pages/img/chose/chose-2/thumb-2.jpg')}}" alt="chose">
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 mb-25">
                <div class="tg-chose-2-content p-relative text-center z-index-1 wow fadeInLeft" data-wow-delay=".6s" data-wow-duration=".6s">
                    <span class="tg-chose-2-box-shape">
                        <svg width="62" height="57" viewBox="0 0 62 57" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M83.0149 6.0725L59.8978 44.6152M83.0149 6.0725L44.4722 29.1896M83.0149 6.0725L48.8307 40.2567M59.8978 44.6152L83.0149 83.158M59.8978 44.6152L62.248 48.7173L79.2974 44.6152L62.3762 40.3849L59.8978 44.6152ZM59.8978 44.6152L50.7108 44.6152M83.0149 83.158L44.4722 60.0409M83.0149 83.158L48.8307 48.9737M44.4722 60.0409L5.92945 83.158M44.4722 60.0409L48.5743 62.391L44.4722 79.4404L40.2419 62.5192L44.4722 60.0409ZM44.4722 60.0409L44.4722 50.8539M5.92945 83.158L29.0465 44.6152M5.92945 83.158L40.1137 48.9737M29.0465 44.6152L5.92944 6.07251M29.0465 44.6152L26.5682 40.3849L9.64698 44.6152L26.5682 48.8455L29.0465 44.6152ZM29.0465 44.6152L38.2
5709 -3.46589e-05 28.4375 3.43491e-08H6.09375C5.96037 -3.46589e-05 5.82828 0.0262116 5.70505 0.0772392C5.58181 0.128267 5.46983 0.203076 5.37552 0.297392C5.2812 0.391709 5.20639 0.503684 5.15536 0.626921C5.10434 0.750158 5.07809 0.882241 5.07812 1.01562V6.09375C5.07809 6.22713 5.10434 6.35922 5.15536 6.48245C5.20639 6.60569 5.2812 6.71767 5.37552 6.81198C5.46983 6.9063 5.58181 6.98111 5.70505 7.03214C5.82828 7.08316 5.96037 7.10941 6.09375 7.10938H9.14062V16.25H6.09375C4.47813 16.2518 2.92919 16.8944 1.78677 18.0368C0.644352 19.1792 0.00176621 20.7281 0 22.3438V54.8438C0.00176621 56.4594 0.644352 58.0083 1.78677 59.1507C2.92919 60.2931 4.47813 60.9357 6.09375 60.9375V62.9688C6.09437 63.5073 6.30857 64.0236 6.68937 64.4044C7.07017 64.7852 7.58647 64.9994 8.125 65H11.1719C11.7104 64.9994 12.2267 64.7852 12.6075 64.4044C12.9883 64.0236 13.2025 63.5073 13.2031 62.9688V60.9375H21.3281V62.9688C21.3287 63.5073 21.5429 64.0236 21.9237 64.4044C22.3045 64.7852 22.8208 64.9994 23.3594 65H26.4062C26.9448 64.9994 27.4611 64.7852 27.8419 64.4044C28.2227 64.0236 28.4369 63.5073 28.4375 62.9688V60.9375C29.2476 60.9369 30.0496 60.7757 30.7969 60.4631C31.5443 60.1505 32.2223 59.6928 32.7916 59.1165C32.9801 58.9256 33.0854 58.668 33.0845 58.3997C33.0837 58.1315 32.9767 57.8745 32.7871 57.6849C32.5974 57.4952 32.3404 57.3883 32.0722 57.3874C31.804 57.3866 31.5463 57.4919 31.3554 57.6804ZM19.2969 7.10938V16.25H15.2344V7.10938H19.2969ZM23.3594 16.25H21.3281V7.10938H23.3594V16.25ZM7.10938 2.03125H27.4219V5.07812H7.10938V2.03125ZM11.1719 7.10938H13.2031V16.25H11.1719V7.10938ZM11.1719 62.9688H8.125V60.9375H11.1719V62.9688ZM26.4062 62.9688H23.3594V60.9375H26.4062V62.9688Z" fill="#560CE3" />
                        </svg>
                    </div>
                    <h4 class="tg-chose-2-title mb-15"><a href="contact.html">Secure Journey With Us</a></h4>
                    <p>Are you tired offer theare typical tourist new destination</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 mb-25">
                <div class="tg-chose-2-thumb  h-100 wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".6s">
                    <img class="w-100 h-100" src="{{ asset('assets/pages/img/chose/chose-2/thumb-3.jpg')}}" alt="chose">
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 mb-25">
                <div class="tg-chose-2-content p-relative text-center z-index-1 wow fadeInRight" data-wow-delay=".6s" data-wow-duration=".6s">
                    <span class="tg-chose-2-box-shape">
                        <svg width="62" height="57" viewBox="0 0 62 57" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="
                            <path d="M29.4553 37.7967C28.8049 37.7967 28.1545 37.4715 27.9919 36.8211L27.3415 34.8699L25.065 33.4065C24.7398 33.2439 24.5772 32.9187 24.5772 32.7561L24.4146 32.5935L23.439 28.8537C23.2764 28.5285 23.2764 28.2033 23.6016 27.878C23.7642 27.5528 24.0894 27.2276 24.5772 27.2276C24.5772 27.2276 24.7398 27.2276 24.9024 27.2276C25.5528 27.2276 26.2033 27.7154 26.2033 28.3659L27.0163 31.4553L29.2927 32.9187C29.4553 33.0813 29.6179 33.2439 29.7805 33.5691L29.9431 33.7317L30.7561 36.3333C30.9187 37.1463 30.4309 37.9593 29.7805 38.1219C29.7805 37.7967 29.6179 37.7967 29.4553 37.7967Z" fill="#560CE3" />
                            <path d="M49.4553 16.1707C45.878 16.1707 42.7886 13.2439 42.7886 9.50406C42.7886 5.76423 45.7154 3 49.4553 3C53.1951 3 56.1219 5.92683 56.1219 9.66667C56.1219 13.4065 53.0325 16.1707 49.4553 16.1707ZM49.4553 5.92683C47.3415 5.92683 45.7154 7.55285 45.7154 9.66667C45.7154 11.7805 47.3415 13.4065 49.4553 13.4065C51.5691 13.4065 53.1951 11.7805 53.1951 9.66667C53.1951 7.55285 51.5691 5.92683 49.4553 5.92683Z" fill="#560CE3" />
                        </svg>
                    </div>
                    <h4 class="tg-chose-2-title mb-15"><a href="contact.html">Top Class Places</a></h4>
                    <p>Are you tired offer theare typical tourist new destination</p>
                </div>
            </div>
        </div>
...
<div class="tg-testimonial-area tg-testimonial-su-wrap p-relative pt-160 pb-50">
    <img class="tg-testimonial-su-shape d-none d-xxl-block" src="{{ asset('assets/pages/img/testimonial/su/shape.png')}}" alt="">
    <img class="tg-testimonial-su-shape-2 d-none d-lg-block" src="{{ asset('assets/pages/img/testimonial/su/shape-2.png')}}" alt="">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-10">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="tg-testimonial-4-slider-thumb">
                                            <img src="{{ asset('assets/pages/img/testimonial/tes-4/tes-1.png')}}" alt="">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tg-testimonial-4-slider-thumb">
                                            <img src="{{ asset('assets/pages/img/testimonial/tes-4/tes-2.png')}}" alt="">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tg-testimonial-4-slider-thumb">
                                            <img src="{{ asset('assets/pages/img/testimonial/tes-4/tes-3.png')}}" alt="">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tg-testimonial-4-slider-thumb">
                                            <img src="{{ asset('assets/pages/img/testimonial/tes-4/tes-4.png')}}" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="swiper-container tg-testimonial-4-slide-active p-relative fix pb-20">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="tg-testimonial-4-content-wrap">
                                    <div class="tg-testimonial-4-clients text-center">
                                        <h5 class="tg-testimonial-4-name mb-0">Mr.Robey Alexa</h5>
                                        <span class="d-inline-block mb-10">CEO, logistra Agency</span>
                                        <div class="tg-testimonial-4-ratings mb-20">
                                        ...
                                        <p>“ Morem ipsum dolor sit amet, consectetur adipisc Service follwing arrea fowlwo awing
                                            elita florai sum dolor sit amet, consectetur area raweaeaw ecall edBorem<br>
                            ...
                            <div class="swiper-slide">
                                <div class="tg-testimonial-4-content-wrap">
                                    <div class="tg-testimonial-4-clients text-center">
                                        <h5 class="tg-testimonial-4-name mb-0">Jamie L. Jorgensen</h5>
                                        <span class="d-inline-block mb-10">CEO, logistra Agency</span>
                                        <div class="tg-testimonial-4-ratings mb-20">
                                            <i class="fa-sharp fa-solid fa-star"></i>
                                            <i class="fa-sharp fa-solid fa-star"></i>
                            ...
                            <div class="swiper-slide">
                                <div class="tg-testimonial-4-content-wrap">
                                    <div class="tg-testimonial-4-clients text-center">
                                        <h5 class="tg-testimonial-4-name mb-0">Jason Whitmore</h5>
                                        <span class="d-inline-block mb-10">Founder</span>
                                        <div class="tg-testimonial-4-ratings mb-20">
                                            <i class="fa-sharp fa-solid fa-star"></i>
                                            <i class="fa-sharp fa-solid fa-star"></i>
                                            <i class="fa-sharp fa-solid fa-star"></i>
                        ...
                        <div class="tg-testimonial-4-slider-navigation">
                            <button class="tg-testimonial-4-slide-next"><i class="fa-solid fa-arrow-right-long"></i></button>
                            <button class="tg-testimonial-4-slide-prev"><i class="fa-solid fa-arrow-left-long"></i></button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay=".4s" data-wow-duration=".9s">
                <div class="tg-blog-item tg-blog-2-item mb-25">
                    <div class="tg-blog-thumb p-relative fix mb-25">
                        <a href="blog-details.html"><img class="w-100" src="{{ asset('assets/pages/img/blog/blog-2/blog-1.jpg')}}" alt="blog"></a>
                        <span class="tg-blog-tag p-absolute">Hiking</span>
                    </div>
                    <div class="tg-blog-content  p-relative">
                        <h3 class="tg-blog-title mb-15"><a href="blog-details.html">Spiritual Sojourn mageey
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">
                <div class="tg-blog-item tg-blog-2-item mb-25">
                    <div class="tg-blog-thumb p-relative fix mb-25">
                        <a href="blog-details.html"><img class="w-100" src="{{ asset('assets/pages/img/blog/blog-2/blog-2.jpg')}}" alt="blog"></a>
                        <span class="tg-blog-tag p-absolute">Travel River</span>
                    </div>
                    <div class="tg-blog-content  p-relative">
                        <h3 class="tg-blog-title mb-15"><a href="blog-details.html">Wine Country Escapeeyard
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInRight" data-wow-delay=".4s" data-wow-duration=".9s">
                <div class="tg-blog-item tg-blog-2-item mb-25">
                    <div class="tg-blog-thumb p-relative fix mb-25">
                        <a href="blog-details.html"><img class="w-100" src="{{ asset('assets/pages/img/blog/blog-2/blog-3.jpg')}}" alt="blog"></a>
                        <span class="tg-blog-tag p-absolute">Travel River</span>
                    </div>
                    <div class="tg-blog-content  p-relative">
                        <h3 class="tg-blog-title mb-15"><a href="blog-details.html">Thrills & Chills treme Sports
...
<div class="tg-cta-area tg-cta-su-wrapper tg-cta-space z-index-9 p-relative">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="tg-cta-wrap include-bg" data-background="{{ asset('assets/pages/img/cta/banner.jpg')}}">
                    <div class="row align-items-end">
                        <div class="col-lg-3 d-none d-lg-block">
                            <div class="tg-cta-thumb pt-50 ml-60">
                                <img src="{{ asset('assets/pages/img/cta/phone.png')}}" alt="">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="tg-cta-apps">
                                <a class="mb-20 d-inline-block mr-5" href="#"><img src="{{ asset('assets/pages/img/cta/google.png')}}" alt=""></a>
                                <a class="mb-20 d-inline-block" href="#"><img src="{{ asset('assets/pages/img/cta/app.png')}}" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
